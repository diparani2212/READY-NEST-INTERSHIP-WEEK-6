...
export const PatientLayout: React.FC<PatientLayoutProps> = ({ children }) => {
    ...
    return (
      <div className="flex min-h-screen items-center justify-center bg-slate-950 text-white">
        <div className="flex items-center gap-3">
          ...
          <span className="text-sm font-medium">Verifying Patient Portal Access...</span>
        </div>
      </div>
    );
  }
    ...
    return (
      <div className="flex min-h-screen flex-col items-center justify-center bg-slate-950 text-slate-100 p-6 text-center">
        ...
        <p className="text-slate-400 max-w-md mb-6 text-sm">
          You must be logged in as a Patient to access the Patient Portal. Doctors and Administrators cannot open patient pages.
        </p>
        <Link
          href="/login"
  ...
  const navItems = [
    ...
    { name: 'Medical Records', href: '/patient/medical-records', icon: Heart },
    { name: 'Invoices & Bills', href: '/patient/bills', icon: Receipt },
      ...
      <div className="min-h-screen bg-slate-950 text-slate-100 flex flex-col md:flex-row">
        ...
        <div className="md:hidden flex items-center justify-between border-b border-slate-800 bg-slate-900 px-4 py-3">
          <div className="flex items-center gap-2.5">
            ...
            <span className="font-bold text-white text-base">CityCare Patient</span>
          </div>
          <button
        ...
        >
          <div>
            ...
            <div className="flex items-center gap-3 px-6 py-6 border-b border-slate-800/80">
              ...
              <div>
                <h2 className="font-bold text-white text-base">CityCare Hospital</h2>
